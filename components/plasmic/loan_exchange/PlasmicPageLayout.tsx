...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: M_5UdzRD_RWf/css

import LoadingIcon from "./icons/PlasmicIcon__Loading"; // plasmic-import: mwrUPJ90flLn/icon
import Icon8Icon from "./icons/PlasmicIcon__Icon8"; // plasmic-import: D2zMCgb1oXfG/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon8Icon
          className={classNames(projectcss.all, sty.svg__nMhWz)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__xkXO)}>
                <LoadingIcon
                  className={classNames(projectcss.all, sty.svg__kIiLc)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__k03M)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__kJfMq)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
